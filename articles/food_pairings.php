...
<!DOCTYPE html>
	...
	<head>
		<meta charset="utf-8">
		<title>SereniTEA - The Perfect Match: Tea and Food Pairings</title>
	...
	<!--Header-->
		...
		<main>
			<div id="breadcrumbs"> <!-- news articles page -->
				<ul>
					<li><a href="../index.php">Home</a> &nbsp; ></li>
					<li class="lastcrumb">The Perfect Match: Tea and Food Pairings</li>
				</ul>    
			</div>
			<div id="wrapper">
				<article id="article_body">
					<h2 id="article_title">
					The Perfect Match: Tea and Food Pairings
					</h2>
					
					<div id="article_banner">
						<img src="../img/slideShow3.jpg" alt="article_banner">
					...
					<div id="article_author">
						...
						<span class="fb-share-button" data-href="http://students.bcitdev.com/A01013921/G20/articles/food_pairings.php" data-layout="button" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fstudents.bcitdev.com%2FA01013921%2FG20%2Farticles%2Farticle.html&amp;src=sdkpreparse">Share</a></span>
